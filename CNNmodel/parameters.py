...
class Dataset:
    ...
    shape_predictor_path='CNNmodel/shape_predictor_68_face_landmarks.dat'
...
class Training:
    ...
    vizualize = True
    logs_dir = "logs"
    checkpoint_dir = "CNNmodel/checkpoints/chk"
    best_checkpoint_path = "CNNmodel/checkpoints/best/"
    max_checkpoints = 1
    checkpoint_frequency = 1.0 # in hours
    save_model = True
    save_model_path = "CNNmodel/best_model/saved_model.bin"
